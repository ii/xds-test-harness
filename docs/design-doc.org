...
#+begin_src dot :file  (ii/workdir+ "docs/assets/architecture.png") :cmdline -Kdot -Tpng
digraph {
        rankdir=LR;
    subgraph cluster_0 {
    label="Test Suite";
...
#+RESULTS:
[[file:/Users/workzach/Projects/xDS-conformance/test-harness/docs/assets/architecture.png]]
